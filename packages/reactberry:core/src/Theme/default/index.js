...
const buttonStyles = {
  ...
  primary: {
    ...
    boxShadow:
      '0 3px 3px -3px hsla(0, 0%, 0%, 0.2), inset 0 -4px 8px -8px hsla(0, 0%, 0%, 0.3)',
    '&:hover': {
...
const shadows = {
  none: '0px 0px 0px rgba(0,0,0,0.125)',
  small: '0px 2px 8px rgba(0,0,0,0.125)',
  medium: '0px 8px 16px rgba(0,0,0,0.125)'
};
