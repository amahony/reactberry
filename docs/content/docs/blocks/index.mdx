...
Use `reactberry/elements` for foundational items:
...
Use `reactberry/blocks` when you want a composed reusable structure with more opinionated behavior or layout built in.
