...
Once the provider and primitives are working, continue with [Theming](/docs/theming), then move to [Using Blocks](/docs/using-blocks) to build larger app patterns.
